...
const Page = async (props: Props) => {
    ...
    return (
        ...
        >
            ...
            >
                <TabsList className="bg-transparent flex gap-3">
                    <TabsTrigger
                        value="all"
                        className="bg-secondary opacity-50 data-[state=active]:opacity-100 px-4 h-10 rounded-md"
                    >
                        All
                    </TabsTrigger>
                    <TabsTrigger
                        value="upcoming"
                        className="bg-secondary px-4 h-10 rounded-md"
                    >
                        Upcoming
                    </TabsTrigger>
                    <TabsTrigger
