    ...
    return (
        <div className="w-full flex flex-col gap-8">
            <div className="w-full flex justify-center sm:justify-between items-center gap-8 flex-wrap">
                <p className="text-primary text-2xl font-semibold">{heading}</p>
            ...
            <div className="w-full flex flex-wrap gap-6 items-center justify-center -mt-7">
                ...
                <div className="md:max-w-1/4 w-full">
                    {children}
                </div>
            </div>
        </div>
